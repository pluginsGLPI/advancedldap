...
/**
 * Inventory builder for Computer itemtype.
 *
 * Maps GLPI Computer fields to the JSON inventory format
 * expected by Glpi\Inventory\Inventory.
 */
class ComputerBuilder extends AbstractInventoryBuilder
{
    /**
     * Mapping of GLPI field names to JSON inventory paths.
     *
     * Based on Glpi\Inventory\MainAsset\MainAsset::prepareForHardware()
     * and prepareForBios() methods.
     */
    private const FIELD_TO_JSON = [
        ...
        'computertypes_id' => 'hardware.chassis_type',
    ];
